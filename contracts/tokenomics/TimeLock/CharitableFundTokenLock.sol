/*  _____________________________________________________________________________
    ...
    Gauss(Gang) Charitable Fund Token Lock Contract
...
contract CharitableFundTokenLock is Context, Ownable {
    ...
    uint256[] private _charitableFundTokenAmountsList = 
            [   13888889,       // liquidityAmount0
                1111111         // liquidityAmount1
            ];
    ...
    constructor(IBEP20 token_, address sender_, address beneficiary_, uint256 amount_) onlyOwner() {
        ...
        _amount = amount_;
        _releaseTime = _charitableFundLockTimes[0];
    ...
    function release() public virtual {
        ...
        uint256 amount = _charitableFundTokenAmountsList[_lockCounter];
        require(amount > 0, "CommunityTokenLock: no tokens to release");

        token().transfer(beneficiary(), amount);
        
        _lockCounter = _lockCounter + 1;
        _releaseTime = _charitableFundLockTimes[_lockCounter];
    }
}